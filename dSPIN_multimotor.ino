...
#define SLAVE_SELECT_PIN 53  // Wire this to the CSN pin
#define MOSI             51  // Wire this to the SDI pin
#define MISO             50  // Wire this to the SDO pin
#define SCK              52  // Wire this to the CK pin

#define dSPIN_RESET_X      5   // Wire this to the STBY line
#define dSPIN_RESET_Y      11   // Wire this to the STBY line
#define dSPIN_RESET_Z      19   // Wire this to the STBY line
//#define dSPIN_BUSYN1      5   // Wire this to the BSYN line
//#define dSPIN_BUSYN2      4   // Wire this to the BUSY line
//#define dSPIN_FLAG       3   // Wire this to the FLAG line

//#define STAT1            14  // Hooked to an LED on the test jig
#define dSPIN_BUSYN_Z           15  // Hooked to an LED on the test jig
...
#define MOTOR_X_STEP    4
#define MOTOR_Y_STEP    12
#define MOTOR_Z_STEP    18
